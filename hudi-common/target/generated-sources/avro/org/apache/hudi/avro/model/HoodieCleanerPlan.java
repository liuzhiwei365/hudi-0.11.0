...
public class HoodieCleanerPlan extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.lang.CharSequence policy;
  @Deprecated public java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> filesToBeDeletedPerPartition;
  @Deprecated public java.lang.Integer version;
  /** This field replaces the field filesToBeDeletedPerPartition */
  @Deprecated public java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieCleanFileInfo>> filePathsToBeDeletedPerPartition;
  /** partitions to be deleted */
  @Deprecated public java.util.List<java.lang.CharSequence> partitionsToBeDeleted;
   ...
   */
  public HoodieCleanerPlan(org.apache.hudi.avro.model.HoodieActionInstant earliestInstantToRetain, java.lang.CharSequence policy, java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> filesToBeDeletedPerPartition, java.lang.Integer version, java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieCleanFileInfo>> filePathsToBeDeletedPerPartition, java.util.List<java.lang.CharSequence> partitionsToBeDeleted) {
  ...
  public java.lang.Object get(int field$) {
    ...
    case 4: return filePathsToBeDeletedPerPartition;
    case 5: return partitionsToBeDeleted;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: policy = (java.lang.CharSequence)value$; break;
    case 2: filesToBeDeletedPerPartition = (java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>>)value$; break;
    case 3: version = (java.lang.Integer)value$; break;
    case 4: filePathsToBeDeletedPerPartition = (java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieCleanFileInfo>>)value$; break;
    case 5: partitionsToBeDeleted = (java.util.List<java.lang.CharSequence>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.lang.CharSequence getPolicy() {
    return policy;
  }
   ...
   * @param value the value to set.
   */
  public void setPolicy(java.lang.CharSequence value) {
    this.policy = value;
  }
   ...
   */
  public java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> getFilesToBeDeletedPerPartition() {
   ...
   * @param value the value to set.
   */
  public void setFilesToBeDeletedPerPartition(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> value) {
   ...
   */
  public java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieCleanFileInfo>> getFilePathsToBeDeletedPerPartition() {
   ...
   * @param value the value to set.
   */
  public void setFilePathsToBeDeletedPerPartition(java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieCleanFileInfo>> value) {
   ...
   */
  public java.util.List<java.lang.CharSequence> getPartitionsToBeDeleted() {
   ...
   * @param value the value to set.
   */
  public void setPartitionsToBeDeleted(java.util.List<java.lang.CharSequence> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HoodieCleanerPlan>
    ...
    private java.lang.CharSequence policy;
    private java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> filesToBeDeletedPerPartition;
    private java.lang.Integer version;
    /** This field replaces the field filesToBeDeletedPerPartition */
    private java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieCleanFileInfo>> filePathsToBeDeletedPerPartition;
    /** partitions to be deleted */
    private java.util.List<java.lang.CharSequence> partitionsToBeDeleted;
    ...
    private Builder(org.apache.hudi.avro.model.HoodieCleanerPlan.Builder other) {
      ...
      if (isValidValue(fields()[4], other.filePathsToBeDeletedPerPartition)) {
        this.filePathsToBeDeletedPerPartition = data().deepCopy(fields()[4].schema(), other.filePathsToBeDeletedPerPartition);
        fieldSetFlags()[4] = true;
      }
      if (isValidValue(fields()[5], other.partitionsToBeDeleted)) {
        this.partitionsToBeDeleted = data().deepCopy(fields()[5].schema(), other.partitionsToBeDeleted);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.hudi.avro.model.HoodieCleanerPlan.Builder setPolicy(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.hudi.avro.model.HoodieCleanerPlan.Builder setFilesToBeDeletedPerPartition(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.hudi.avro.model.HoodieCleanerPlan.Builder setFilePathsToBeDeletedPerPartition(java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieCleanFileInfo>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.hudi.avro.model.HoodieCleanerPlan.Builder setPartitionsToBeDeleted(java.util.List<java.lang.CharSequence> value) {
    ...
    public HoodieCleanerPlan build() {
      try {
        ...
        record.policy = fieldSetFlags()[1] ? this.policy : (java.lang.CharSequence) defaultValue(fields()[1]);
        record.filesToBeDeletedPerPartition = fieldSetFlags()[2] ? this.filesToBeDeletedPerPartition : (java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>>) defaultValue(fields()[2]);
        record.version = fieldSetFlags()[3] ? this.version : (java.lang.Integer) defaultValue(fields()[3]);
        record.filePathsToBeDeletedPerPartition = fieldSetFlags()[4] ? this.filePathsToBeDeletedPerPartition : (java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieCleanFileInfo>>) defaultValue(fields()[4]);
        record.partitionsToBeDeleted = fieldSetFlags()[5] ? this.partitionsToBeDeleted : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[5]);
        return record;
