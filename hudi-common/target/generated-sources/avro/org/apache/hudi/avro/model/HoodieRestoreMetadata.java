...
public class HoodieRestoreMetadata extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.lang.CharSequence startRestoreTime;
  @Deprecated public long timeTakenInMillis;
  @Deprecated public java.util.List<java.lang.CharSequence> instantsToRollback;
  @Deprecated public java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieRollbackMetadata>> hoodieRestoreMetadata;
  @Deprecated public java.lang.Integer version;
  @Deprecated public java.util.List<org.apache.hudi.avro.model.HoodieInstantInfo> restoreInstantInfo;
   ...
   */
  public HoodieRestoreMetadata(java.lang.CharSequence startRestoreTime, java.lang.Long timeTakenInMillis, java.util.List<java.lang.CharSequence> instantsToRollback, java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieRollbackMetadata>> hoodieRestoreMetadata, java.lang.Integer version, java.util.List<org.apache.hudi.avro.model.HoodieInstantInfo> restoreInstantInfo) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: startRestoreTime = (java.lang.CharSequence)value$; break;
    case 1: timeTakenInMillis = (java.lang.Long)value$; break;
    case 2: instantsToRollback = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: hoodieRestoreMetadata = (java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieRollbackMetadata>>)value$; break;
    case 4: version = (java.lang.Integer)value$; break;
    case 5: restoreInstantInfo = (java.util.List<org.apache.hudi.avro.model.HoodieInstantInfo>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.lang.CharSequence getStartRestoreTime() {
   ...
   */
  public void setStartRestoreTime(java.lang.CharSequence value) {
   ...
   */
  public java.util.List<java.lang.CharSequence> getInstantsToRollback() {
   ...
   * @param value the value to set.
   */
  public void setInstantsToRollback(java.util.List<java.lang.CharSequence> value) {
   ...
   */
  public java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieRollbackMetadata>> getHoodieRestoreMetadata() {
   ...
   * @param value the value to set.
   */
  public void setHoodieRestoreMetadata(java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieRollbackMetadata>> value) {
   ...
   */
  public java.util.List<org.apache.hudi.avro.model.HoodieInstantInfo> getRestoreInstantInfo() {
   ...
   * @param value the value to set.
   */
  public void setRestoreInstantInfo(java.util.List<org.apache.hudi.avro.model.HoodieInstantInfo> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HoodieRestoreMetadata>
    ...
    private java.lang.CharSequence startRestoreTime;
    private long timeTakenInMillis;
    private java.util.List<java.lang.CharSequence> instantsToRollback;
    private java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieRollbackMetadata>> hoodieRestoreMetadata;
    private java.lang.Integer version;
    private java.util.List<org.apache.hudi.avro.model.HoodieInstantInfo> restoreInstantInfo;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.hudi.avro.model.HoodieRestoreMetadata.Builder setStartRestoreTime(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.hudi.avro.model.HoodieRestoreMetadata.Builder setInstantsToRollback(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.hudi.avro.model.HoodieRestoreMetadata.Builder setHoodieRestoreMetadata(java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieRollbackMetadata>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.hudi.avro.model.HoodieRestoreMetadata.Builder setRestoreInstantInfo(java.util.List<org.apache.hudi.avro.model.HoodieInstantInfo> value) {
    ...
    public HoodieRestoreMetadata build() {
      try {
        ...
        record.startRestoreTime = fieldSetFlags()[0] ? this.startRestoreTime : (java.lang.CharSequence) defaultValue(fields()[0]);
        record.timeTakenInMillis = fieldSetFlags()[1] ? this.timeTakenInMillis : (java.lang.Long) defaultValue(fields()[1]);
        record.instantsToRollback = fieldSetFlags()[2] ? this.instantsToRollback : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.hoodieRestoreMetadata = fieldSetFlags()[3] ? this.hoodieRestoreMetadata : (java.util.Map<java.lang.CharSequence,java.util.List<org.apache.hudi.avro.model.HoodieRollbackMetadata>>) defaultValue(fields()[3]);
        record.version = fieldSetFlags()[4] ? this.version : (java.lang.Integer) defaultValue(fields()[4]);
        record.restoreInstantInfo = fieldSetFlags()[5] ? this.restoreInstantInfo : (java.util.List<org.apache.hudi.avro.model.HoodieInstantInfo>) defaultValue(fields()[5]);
        return record;
